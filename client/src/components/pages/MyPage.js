        ...
        <div className='myPageLeftPane'>
          <div className='nameContainer'>
            <div style={{ display: 'flex', flexDirection: 'column', alignContent: 'center', textAlign: 'center' }}>
              ...
              />
              <p style={{ fontSize: '20px', marginTop: '-2px' }}><b>3870</b></p>
            </div>
          </div>
          <br />
          ...
          <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', margin: 'auto', width: '300px', marginTop: '5px' }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <img src={masterLogo} alt='master' style={{ width: '50px', height: '50px' }} />
              <p style={{ fontSize: '18px', marginTop: '3px' }}><b>3500</b></p>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px' }}>
              <img src={granmasterLogo} alt='granmaster' style={{ width: '50px', height: '50px', }} />
              <p style={{ fontSize: '18px', marginTop: '3px' }}><b>4000</b></p>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', margin: 'auto', width: '200px', marginTop: '-10px' }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <p style={{ fontSize: '25px' }}><b>158</b></p>
              <p style={{ fontSize: '20px', marginTop: '-10px' }}>Answered</p>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <p style={{ fontSize: '25px' }}><b>37</b></p>
